...
const addBooking = (ride_id,rider_id,seats_booked) => {
  let booking_status='pending';
  return pool
    .query(
      `INSERT INTO bookings (ride_id,rider_id,seats_booked,booking_status) VALUES ($1,$2,$3,$4) RETURNING *;`      
                          , [ride_id,rider_id,seats_booked,booking_status]             
    )
    .then((response) => {
